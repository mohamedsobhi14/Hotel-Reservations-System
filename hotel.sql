...
UPDATE Guests  
SET          Fname = ‘Youssef ‘, Lname= `Ali`, Email=`youssefali231@gmail.com`                                                        
WHERE     id=’200`;

UPDATE Guests  
SET	Fname = ‘Nabil ‘, Lname=`Ahmed`, Email="nabilahmed556@gmail.com"	                                                    
WHERE		id=’210`;
UPDATE Guests
SET	Fname = ‘Mohamed ‘, Lname=`Ali`, Email="mohamedali56@gmail.com"
WHERE		id=’212`;
UPDATE Guests
SET	Fname = ‘Khalid ‘, Lname=`Mohamed`, Email="khalidmohamed500@gmail.com"                      WHERE		id=’216`;
UPDATE Guests
SET	Fname = ‘Mustafa', Lname=`Mahmoud', Email="mustafamahmoud040@gmail.com"
WHERE	id=’220`;
